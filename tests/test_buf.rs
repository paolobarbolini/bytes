...
macro_rules! buf_tests {
    ...
    ($make_input:ident, $checks_vectored_is_complete:expr) => {
        ...
        buf_tests!(number $make_input, get_u16_ne, get_u16_ne_overflow, u16, get_u16_ne, 0x46ff);
        ...
        buf_tests!(number $make_input, get_i16_ne, get_i16_ne_overflow, i16, get_i16_ne, 0x46ff);
        ...
        buf_tests!(number $make_input, get_u32_ne, get_u32_ne_overflow, u32, get_u32_ne, 0x727146ff);
        ...
        buf_tests!(number $make_input, get_i32_ne, get_i32_ne_overflow, i32, get_i32_ne, 0x727146ff);
        ...
        buf_tests!(number $make_input, get_u64_ne, get_u64_ne_overflow, u64, get_u64_ne, 0x7144726a727146ff);
        ...
        buf_tests!(number $make_input, get_i64_ne, get_i64_ne_overflow, i64, get_i64_ne, 0x7144726a727146ff);
        ...
        buf_tests!(number $make_input, get_u128_ne, get_u128_ne_overflow, u128, get_u128_ne, 0x76353463547668507144726a727146ff);
        ...
        buf_tests!(number $make_input, get_i128_ne, get_i128_ne_overflow, i128, get_i128_ne, 0x76353463547668507144726a727146ff);
        ...
        buf_tests!(number $make_input, get_f32_ne, get_f32_ne_overflow, f32, get_f32_ne, f32::from_bits(0x727146ff));
        ...
        buf_tests!(number $make_input, get_f64_ne, get_f64_ne_overflow, f64, get_f64_ne, f64::from_bits(0x7144726a727146ff));
        ...
        buf_tests!(var_number $make_input, get_uint_ne, get_uint_ne_overflow, u64, get_uint_ne, 3, 0x7146ff);
        ...
        buf_tests!(var_number $make_input, get_int_ne, get_int_ne_overflow, i64, get_int_ne, 3, 0x7146ff);
    };
...
mod vec_deque {
    fn make_input(buf: &'static [u8]) -> impl Buf {
        buf.iter().copied().collect::<VecDeque<u8>>()
    }
